...
var EcdsaAlgorithm = /** @class */ (function (_super) {
    ...
    function EcdsaAlgorithm() {
        ...
        _this.hashAlgorithms = ['SHA-256'];
        _this.namedCurves = ['secp256k1'];
        return _this;
    }
    EcdsaAlgorithm.prototype.generateKey = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, extractable, keyUsages, keyPair, cryptoKeyPair, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        algorithm = options.algorithm, extractable = options.extractable, keyUsages = options.keyUsages;
                        this.checkGenerateKey({ algorithm: algorithm, keyUsages: keyUsages });
                        _b = algorithm.namedCurve;
                        switch (_b) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, cryptoKeyPair];
                }
            });
        });
    };
    EcdsaAlgorithm.prototype.sign = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, key, data, signature, keyAlgorithm, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        algorithm = options.algorithm, key = options.key, data = options.data;
                        ...
                        _a = keyAlgorithm.namedCurve;
                        switch (_a) {
                            case 'secp256k1': return [3 /*break*/, 1];
                        }
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, index_js_1.Secp256k1.sign({ hash: algorithm.hash, key: key.material, data: data })];
                    case 2:
                        signature = _b.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new TypeError("Out of range: '".concat(keyAlgorithm.namedCurve, "'. Must be one of '").concat(this.namedCurves.join(', '), "'"));
                    case 4: return [2 /*return*/, signature];
                }
            });
        });
    };
    EcdsaAlgorithm.prototype.verify = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, key, signature, data, isValid, keyAlgorithm, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        algorithm = options.algorithm, key = options.key, signature = options.signature, data = options.data;
                        this.checkAlgorithmOptions({ algorithm: algorithm });
                        // The key's algorithm must match the algorithm implementation processing the operation.
                        this.checkKeyAlgorithm({ keyAlgorithmName: key.algorithm.name });
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, index_js_1.Secp256k1.verify({ hash: algorithm.hash, key: key.material, signature: signature, data: data })];
                    case 2:
                        isValid = _b.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new TypeError("Out of range: '".concat(keyAlgorithm.namedCurve, "'. Must be one of '").concat(this.namedCurves.join(', '), "'"));
