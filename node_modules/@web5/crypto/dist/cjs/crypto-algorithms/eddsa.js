...
var EdDsaAlgorithm = /** @class */ (function (_super) {
    ...
    function EdDsaAlgorithm() {
        ...
        _this.namedCurves = ['Ed25519', 'Ed448'];
        return _this;
    }
    EdDsaAlgorithm.prototype.generateKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, extractable, keyUsages, keyPair, cryptoKeyPair, _a;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, index_js_1.Ed25519.sign({ key: key.material, data: data })];
                    case 2:
                        signature = _b.sent();
                        return [3 /*break*/, 4];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, index_js_1.Ed25519.verify({ key: key.material, signature: signature, data: data })];
                    case 2:
                        isValid = _b.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new TypeError("Out of range: '".concat(keyAlgorithm.namedCurve, "'. Must be one of '").concat(this.namedCurves.join(', '), "'"));
