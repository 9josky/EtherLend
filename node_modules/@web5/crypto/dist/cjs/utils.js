...
exports.randomUuid = exports.randomBytes = exports.multibaseIdToKey = exports.keyToMultibaseId = exports.isCryptoKeyPair = exports.isBytesKeyPair = exports.checkValidProperty = exports.checkRequiredProperty = void 0;
...
function isBytesKeyPair(key) {
    return (key && 'privateKey' in key && 'publicKey' in key &&
        (0, common_1.universalTypeOf)(key.privateKey) === 'Uint8Array' &&
        (0, common_1.universalTypeOf)(key.publicKey) === 'Uint8Array') ? true : false;
}
