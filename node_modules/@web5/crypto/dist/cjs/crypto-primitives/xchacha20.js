...
var XChaCha20 = /** @class */ (function () {
    ...
    XChaCha20.decrypt = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var data, key, nonce, ciphertext;
            return __generator(this, function (_a) {
                data = options.data, key = options.key, nonce = options.nonce;
                ciphertext = (0, chacha_1.xchacha20)(key, nonce, data);
                return [2 /*return*/, ciphertext];
            });
        });
    };
    XChaCha20.encrypt = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var data, key, nonce, plaintext;
            return __generator(this, function (_a) {
                data = options.data, key = options.key, nonce = options.nonce;
                plaintext = (0, chacha_1.xchacha20)(key, nonce, data);
