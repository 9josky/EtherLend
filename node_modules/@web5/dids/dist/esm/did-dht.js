...
export class DidDhtMethod {
    ...
    static create(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publish) {
                yield this.publish({ keySet, didDocument: document });
            }
            return {
                did: document.id,
                document: document,
    ...
    static publish({ didDocument, keySet }) {
        return __awaiter(this, void 0, void 0, function* () {
            const publicCryptoKey = yield Jose.jwkToCryptoKey({ key: keySet.identityKey.publicKeyJwk });
            const privateCryptoKey = yield Jose.jwkToCryptoKey({ key: keySet.identityKey.privateKeyJwk });
