...
var DidApi = /** @class */ (function () {
     ...
     */
    DidApi.prototype.resolve = function (didUrl, resolutionOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var agentResponse, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.agent.processDidRequest({
                            messageOptions: { didUrl: didUrl, resolutionOptions: resolutionOptions },
                            messageType: agent_1.DidMessage.Resolve
                        })];
                    case 1:
