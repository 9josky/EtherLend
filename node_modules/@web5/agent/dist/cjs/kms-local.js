...
var utils_1 = require("@web5/crypto/utils");
...
exports.defaultAlgorithms = {
    'AES-CTR': crypto_1.AesCtrAlgorithm,
    ECDH: crypto_1.EcdhAlgorithm,
    ECDSA: crypto_1.EcdsaAlgorithm,
    EdDSA: crypto_1.EdDsaAlgorithm,
};
var LocalKms = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cryptoKey = _a.sent();
                        if (!(0, utils_1.isCryptoKeyPair)(cryptoKey)) return [3 /*break*/, 3];
    ...
    LocalKms.prototype.getAlgorithm = function (algorithmIdentifier) {
        (0, utils_1.checkRequiredProperty)({ property: 'name', inObject: algorithmIdentifier });
