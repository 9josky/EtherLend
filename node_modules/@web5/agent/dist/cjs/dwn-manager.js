...
var DwnManager = /** @class */ (function () {
    ...
    DwnManager.prototype.constructDwnMessage = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var request, readableStream, messageOptions, dataStream, isomorphicNodeReadable, _b, forCid, forProcessMessage, _c, dwnAuthorizationSigner, messageCreator, dwnMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _d.label = 2;
                    case 2: return [4 /*yield*/, this.constructDwnAuthorizationSigner(request.author)];
                    case 3:
                        dwnAuthorizationSigner = _d.sent();
                        messageCreator = dwnMessageCreators[request.messageType];
                        return [4 /*yield*/, messageCreator.create(__assign(__assign({}, request.messageOptions), { authorizationSigner: dwnAuthorizationSigner }))];
                    case 4:
                        dwnMessage = _d.sent();
                        return [2 /*return*/, { message: dwnMessage.toJSON(), dataStream: readableStream }];
                }
            });
        });
    };
    ...
    DwnManager.prototype.constructDwnAuthorizationSigner = function (author) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DwnManager.prototype.getDwnMessage = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var author, messageType, messageCid, dwnAuthorizationSigner, messagesGet, result, _a, messageEntry, message, dwnMessage, encodedData, writeMessage, dataBytes, recordsRead, reply, _b, code, detail, dataBytes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        author = options.author, messageType = options.messageType, messageCid = options.messageCid;
                        return [4 /*yield*/, this.constructDwnAuthorizationSigner(author)];
                    case 1:
                        dwnAuthorizationSigner = _c.sent();
                    ...
                    case 5:
                        recordsRead = _c.sent();
                        return [4 /*yield*/, this._dwn.processMessage(author, recordsRead.toJSON())];
                    case 6:
                        reply = _c.sent();
    ...
    DwnManager.prototype.createMessage = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var author, messageOptions, messageType, dwnAuthorizationSigner, messageCreator, dwnMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.constructDwnAuthorizationSigner(author)];
                    case 1:
                        dwnAuthorizationSigner = _a.sent();
                        messageCreator = dwnMessageCreators[messageType];
                        return [4 /*yield*/, messageCreator.create(__assign(__assign({}, messageOptions), { authorizationSigner: dwnAuthorizationSigner }))];
                    case 2:
                        dwnMessage = _a.sent();
