 ...
 *
 */
var IdentityStoreDwn = /** @class */ (function () {
    function IdentityStoreDwn() {
        this._identityRecordProperties = {
            dataFormat: 'application/json',
            schema: 'https://identity.foundation/schemas/web5/managed-identity'
        };
    }
    IdentityStoreDwn.prototype.deleteIdentity = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var agent, context, did, authorDid, queryReply, matchingRecordId, _b, _c, record, storedIdentity, status;
            var e_1, _d;
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, agent.dwnManager.processRequest({
                                ...
                                messageOptions: {
                                    filter: __assign({}, this._identityRecordProperties)
                                }
                            })];
                    case 2:
                        ...
                        try {
                            for (_b = __values((_a = queryReply.entries) !== null && _a !== void 0 ? _a : []), _c = _b.next(); !_c.done; _c = _b.next()) {
                                ...
                                if (record.encodedData) {
                                    storedIdentity = common_1.Convert.base64Url(record.encodedData).toObject();
    ...
    IdentityStoreDwn.prototype.getIdentity = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var agent, context, did, authorDid, queryReply, _b, _c, record, storedIdentity;
            var e_2, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, agent.dwnManager.processRequest({
                                ...
                                target: authorDid,
                                messageType: 'RecordsQuery',
                                messageOptions: { filter: __assign({}, this._identityRecordProperties) }
                            })];
                    case 2:
                        queryReply = (_e.sent()).reply;
                        try {
                            ...
                            for (_b = __values((_a = queryReply.entries) !== null && _a !== void 0 ? _a : []), _c = _b.next(); !_c.done; _c = _b.next()) {
                                ...
                                if (record.encodedData) {
                                    storedIdentity = common_1.Convert.base64Url(record.encodedData).toObject();
                                    if (storedIdentity && storedIdentity.did === did)
                                        return [2 /*return*/, storedIdentity];
                                }
                            }
                        }
    ...
    IdentityStoreDwn.prototype.importIdentity = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var agent, context, identity, authorDid, duplicateFound, identityU8A, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        agent = options.agent, context = options.context, identity = options.identity;
                        return [4 /*yield*/, this.getAuthor({ agent: agent, context: context, did: identity.did })];
                    case 1:
                        authorDid = _a.sent();
                        return [4 /*yield*/, this.getIdentity({ agent: agent, context: context, did: identity.did })];
                    case 2:
                        duplicateFound = _a.sent();
                        if (duplicateFound) {
                            throw new Error("IdentityStoreDwn: Identity with DID already exists: '".concat(identity.did, "'"));
                        }
                        identityU8A = common_1.Convert.object(identity).toUint8Array();
                        return [4 /*yield*/, agent.dwnManager.processRequest({
                                author: authorDid,
                                target: authorDid,
                                messageType: 'RecordsWrite',
                                messageOptions: __assign({}, this._identityRecordProperties),
    ...
    IdentityStoreDwn.prototype.listIdentities = function (options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var agent, context, authorDid, queryReply, storedIdentities, _b, _c, record, storedIdentity;
            var e_3, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, storedIdentities];
                }
            });
        });
    };
    IdentityStoreDwn.prototype.getAuthor = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        throw new Error("IdentityStoreDwn: Agent property 'agentDid' is undefined and no keys were found for: '".concat(did, "'"));
                }
            });
        });
    };
    return IdentityStoreDwn;
}());
exports.IdentityStoreDwn = IdentityStoreDwn;
/**
 *
 */
var IdentityStoreMemory = /** @class */ (function () {
    function IdentityStoreMemory() {
        /**
         * A private field that contains the Map used as the in-memory key-value store.
         */
        this.store = new Map();
    }
    IdentityStoreMemory.prototype.deleteIdentity = function (_a) {
        var did = _a.did;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
    ...
    IdentityStoreMemory.prototype.getIdentity = function (_a) {
        var did = _a.did;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
    ...
    IdentityStoreMemory.prototype.importIdentity = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.store.has(identity.did)) {
                    ...
                    throw new Error("IdentityStoreMemory: Identity with DID already exists: '".concat(identity.did, "'"));
                }
                clonedIdentity = structuredClone(identity);
                this.store.set(identity.did, clonedIdentity);
                return [2 /*return*/];
            });
        });
    };
    IdentityStoreMemory.prototype.listIdentities = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
