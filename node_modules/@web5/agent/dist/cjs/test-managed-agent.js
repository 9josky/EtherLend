...
var stores_1 = require("@tbd54566975/dwn-sdk-js/stores");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dwnDataStore = new stores_1.DataStoreLevel({ blockstoreLocation: testDataPath('DWN_DATASTORE') });
                        dwnEventLog = new stores_1.EventLogLevel({ location: testDataPath('DWN_EVENTLOG') });
                        dwnMessageStore = new stores_1.MessageStoreLevel({
