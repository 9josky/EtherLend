...
export class DwnManager {
    ...
    constructDwnMessage(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dwnAuthorizationSigner = yield this.constructDwnAuthorizationSigner(request.author);
            const messageCreator = dwnMessageCreators[request.messageType];
            const dwnMessage = yield messageCreator.create(Object.assign(Object.assign({}, request.messageOptions), { authorizationSigner: dwnAuthorizationSigner }));
    ...
    constructDwnAuthorizationSigner(author) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getDwnMessage(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dwnAuthorizationSigner = yield this.constructDwnAuthorizationSigner(author);
    ...
    createMessage(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dwnMessage = yield messageCreator.create(Object.assign(Object.assign({}, messageOptions), { authorizationSigner: dwnAuthorizationSigner }));
            return dwnMessage;
        });
    }
    /**
