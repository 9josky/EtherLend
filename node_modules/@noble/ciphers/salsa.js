...
const xsalsa20_poly1305 = (key, nonce) => {
    ...
    return {
        ...
        encrypt: (plaintext) => {
            ...
            (0, exports.xsalsa20)(key, nonce, res, res);
            const authKey = res.subarray(0, 32);
            const tag = (0, _poly1305_js_1.poly1305)(res.subarray(32), authKey);
            res.set(tag, 16);
        ...
        decrypt: (ciphertext) => {
            ...
            const tag = (0, _poly1305_js_1.poly1305)(c.subarray(32), authKey);
            if (!(0, utils_js_1.equalBytes)(c.subarray(16, 32), tag))
                throw new Error('Wrong tag');
            const decoded = (0, exports.xsalsa20)(key, nonce, c);
            // Clean authkey && tag stuff
