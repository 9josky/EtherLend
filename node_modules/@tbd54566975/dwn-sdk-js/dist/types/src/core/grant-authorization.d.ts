...
export declare class GrantAuthorization {
     ...
     */
    static authorizeGenericMessage(tenant: string, incomingMessage: Message<GenericMessage>, author: string, permissionsGrantId: string, messageStore: MessageStore): Promise<PermissionsGrantMessage>;
    /**
