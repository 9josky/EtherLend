...
describe('RecordsWrite', () => {
    describe('create()', () => {
        ...
        it('should throw if delegated grant is given but signer is not given', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const grantToBob = yield PermissionsGrant.create({
                delegated: true,
    ...
    describe('parse()', () => {
        it('should throw if a delegate invokes a delegated grant (ID) but the delegated grant is not given', () => __awaiter(void 0, void 0, void 0, function* () {
            const alice = yield TestDataGenerator.generatePersona();
            const bob = yield TestDataGenerator.generatePersona();
            const scope = {
                interface: DwnInterfaceName.Records,
            ...
            yield expect(parsePromise).to.be.rejectedWith(DwnErrorCode.RecordsValidateIntegrityDelegatedGrantAndIdExistenceMismatch);
        }));
    });
    ...
    describe('signAsOwner()', () => {
        it('should throw if the RecordsWrite is not signed by an author yet', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(recordsWrite.signAsOwner(Jws.createSigner(alice))).to.rejectedWith(DwnErrorCode.RecordsWriteSignAsOwnerUnknownAuthor);
