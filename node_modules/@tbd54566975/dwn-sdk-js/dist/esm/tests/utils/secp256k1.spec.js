...
describe('Secp256k1', () => {
    ...
    describe('derivePublic/PrivateKey()', () => {
        it('should be able to derive same key using different ancestor along the chain path', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const publicKeyG = yield Secp256k1.derivePublicKey(privateKey, fullPathToG);
            const publicKeyGFromD = yield Secp256k1.derivePublicKey(privateKeyD, relativePathFromDToG);
