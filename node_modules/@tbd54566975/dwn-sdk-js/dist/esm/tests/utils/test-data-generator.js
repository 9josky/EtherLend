...
import { DidKeyResolver, EventsGet, Jws, MessagesGet, ProtocolsConfigure, ProtocolsQuery, RecordsDelete, RecordsQuery, RecordsWrite } from '../../src/index.js';
/**
...
export class TestDataGenerator {
    ...
    static generateProtocolEncryptedRecordsWrite(input) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const { plaintextBytes, author, recipient, protocolDefinition, protocolPath, protocolContextId, protocolContextDerivingRootKeyId, protocolContextDerivedPublicJwk, protocolParentId, } = input;
    ...
    static generatePermissionsGrant(input) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const dateExpires = (_a = input === null || input === void 0 ? void 0 : input.dateExpires) !== null && _a !== void 0 ? _a : Time.createOffsetTimestamp({ seconds: 60 * 60 * 24 });
            ...
            const permissionsGrant = yield PermissionsGrant.create({
                messageTimestamp: (_c = input === null || input === void 0 ? void 0 : input.messageTimestamp) !== null && _c !== void 0 ? _c : Time.getCurrentTimestamp(),
                dateExpires,
