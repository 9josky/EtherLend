    ...
    describe('ProtocolsConfigureHandler.handle()', () => {
        ...
        describe('functional tests', () => {
            ...
            it('should be able to overwrite existing protocol if timestamp is newer', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply1 = yield dwn.processMessage(alice.did, middleProtocolsConfigure.message, middleProtocolsConfigure.dataStream);
                expect(reply1.status.code).to.equal(202);
                // older messages will not overwrite the existing
                const reply2 = yield dwn.processMessage(alice.did, oldProtocolsConfigure.message, oldProtocolsConfigure.dataStream);
                ...
                const reply3 = yield dwn.processMessage(alice.did, newProtocolsConfigure.message, newProtocolsConfigure.dataStream);
            ...
            it('should only be able to overwrite existing protocol if new protocol is lexicographically larger and timestamps are identical', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const reply2 = yield dwn.processMessage(alice.did, lowestProtocolsConfigure.message, lowestProtocolsConfigure.dataStream);
                expect(reply2.status.code).to.equal(409);
                // test that the protocol with the largest lexicographic value can be written
                const reply3 = yield dwn.processMessage(alice.did, highestProtocolsConfigure.message, highestProtocolsConfigure.dataStream);
                expect(reply3.status.code).to.equal(202);
