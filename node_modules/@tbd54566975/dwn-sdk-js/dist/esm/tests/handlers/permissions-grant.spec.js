        ...
        describe('functional tests', () => {
            ...
            describe('scope validation', () => {
                it('ensures that `schema` and protocol related fields `protocol`, `contextId` or `protocolPath` are not both present', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    schemaAndProtocolGrant.message.authorization = yield Message.createAuthorizationAsAuthor(schemaAndProtocolGrant.message.descriptor, Jws.createSigner(alice));
                    ...
                    schemaAndContextIdGrant.message.authorization = yield Message.createAuthorizationAsAuthor(schemaAndContextIdGrant.message.descriptor, Jws.createSigner(alice));
                    ...
                    schemaAndProtocolPathGrant.message.authorization = yield Message.createAuthorizationAsAuthor(schemaAndProtocolPathGrant.message.descriptor, Jws.createSigner(alice));
                ...
                it('ensures that `contextId` and `protocolPath` are not both present in grant scope', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    contextIdAndProtocolPathGrant.message.authorization = yield Message.createAuthorizationAsAuthor(contextIdAndProtocolPathGrant.message.descriptor, Jws.createSigner(alice));
