...
export function testEventsGetHandler() {
    describe('EventsGetHandler.handle()', () => {
        ...
        it('returns all events for a tenant if watermark is not provided', () => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const alice = yield DidKeyResolver.generate();
            const expectedCids = [];
            for (let i = 0; i < 5; i += 1) {
        ...
        it('returns all events after watermark if watermark is provided', () => __awaiter(this, void 0, void 0, function* () {
            const alice = yield DidKeyResolver.generate();
            for (let i = 0; i < 5; i += 1) {
                const { message, dataStream } = yield TestDataGenerator.generateRecordsWrite({ author: alice });
                const reply = yield dwn.processMessage(alice.did, message, dataStream);
