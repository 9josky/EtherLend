    ...
    describe('RecordsWriteHandler.handle()', () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe('functional tests', () => {
            ...
            it('should inherit data from previous RecordsWrite given a matching dataCid and dataSize and no dataStream', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const readMessageReply = yield dwn.handleRecordsRead(tenant, readMessage.message);
            ...
            describe('owner signature tests', () => {
                it('should use `ownerSignature` for authorization when it is given - flat-space', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const readReply = yield dwn.handleRecordsRead(bob.did, recordsRead.message);
                ...
                it('should throw if `ownerSignature` in `authorization` is mismatching with the tenant - protocol-space', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const protocolWriteReply = yield dwn.processMessage(carol.did, protocolsConfig.message, protocolsConfig.dataStream);
                    expect(protocolWriteReply.status.code).to.equal(202);
                    // Test that Carol is not able to store the message Alice created
                    const carolWriteReply = yield dwn.processMessage(carol.did, recordsWrite.message, dataStream);
                    expect(carolWriteReply.status.code).to.equal(401);
            ...
            describe('should return 400 if actual data size mismatches with `dataSize` in descriptor', () => {
                it('with dataStream and `dataSize` larger than encodedData threshold', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const authorSignature = yield RecordsWrite['createAuthorSignature'](recordId, message.contextId, descriptorCid, message.attestation, message.encryption, authorizationSigner, undefined);
            ...
            describe('protocol based writes', () => {
                ...
                describe('recipient rules', () => {
                    it('should allow write with ancestor recipient rule', () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const protocolWriteReply = yield dwn.processMessage(alice.did, protocolsConfig.message);
                        expect(protocolWriteReply.status.code).to.equal(202);
                ...
                describe('author action rules', () => {
                    it('allow author to write with ancestor author rule and block non-authors', () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const protocolWriteReply = yield dwn.processMessage(bob.did, protocolsConfig.message);
                        expect(protocolWriteReply.status.code).to.equal(202);
                ...
                describe('role rules', () => {
                    ...
                    describe('write contextRole records', () => {
                        ...
                        it('allows a new $contextRole record to be created for the same recipient in the same context if their old one was deleted', () => __awaiter(this, void 0, void 0, function* () {
                            ...
                            const partipantDelete = yield TestDataGenerator.generateRecordsDelete({
                                author: alice,
                                recordId: participantRecord1.message.recordId,
                            });
                            const participantDeleteReply = yield dwn.processMessage(alice.did, partipantDelete.message);
                ...
                it('should allow overwriting records by the same author', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const bobRecordQueryReply = yield dwn.processMessage(alice.did, messageDataForQueryingBobsWrite.message);
                    expect(bobRecordQueryReply.status.code).to.equal(200);
                    expect((_b = bobRecordQueryReply.entries) === null || _b === void 0 ? void 0 : _b.length).to.equal(1);
                ...
                it('should not allow to change immutable recipient', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const bobRecordQueryReply = yield dwn.processMessage(alice.did, messageDataForQueryingBobsWrite.message);
                    expect(bobRecordQueryReply.status.code).to.equal(200);
                    expect((_e = bobRecordQueryReply.entries) === null || _e === void 0 ? void 0 : _e.length).to.equal(1);
                    expect(bobRecordQueryReply.entries[0].encodedData).to.equal(base64url.baseEncode(bobData));
                ...
                it('should look up recipient path with ancestor depth of 2+ (excluding self) in action rule correctly', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    expect(recordsQueryReply.status.code).to.equal(200);
                    expect((_f = recordsQueryReply.entries) === null || _f === void 0 ? void 0 : _f.length).to.equal(1);
                    expect(recordsQueryReply.entries[0].descriptor.dataCid)
                ...
                it('should return 400 if protocol is not normalized', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const authorSignature = yield RecordsWrite.createAuthorSignature(recordsWrite.message.recordId, recordsWrite.message.contextId, descriptorCid, attestation, recordsWrite.message.encryption, Jws.createSigner(alice), undefined);
                    recordsWrite.message = Object.assign(Object.assign({}, recordsWrite.message), { attestation, authorization: { authorSignature } });
        ...
        describe('authorization validation tests', () => {
            it('should return 400 if `recordId` in `authorization` payload mismatches with `recordId` in the message', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const authorSignaturePayload = Object.assign({}, recordsWrite.authorSignaturePayload);
                authorSignaturePayload.recordId = yield TestDataGenerator.randomCborSha256Cid(); // make recordId mismatch in authorization payload
            ...
            it('should return 400 if `contextId` in `authorization` payload mismatches with `contextId` in the message', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const authorSignaturePayload = Object.assign({}, recordsWrite.authorSignaturePayload);
                authorSignaturePayload.contextId = yield TestDataGenerator.randomCborSha256Cid(); // make contextId mismatch in authorization payload
                const authorSignaturePayloadBytes = Encoder.objectToBytes(authorSignaturePayload);
                const signer = Jws.createSigner(author);
                const jwsBuilder = yield GeneralJwsBuilder.create(authorSignaturePayloadBytes, [signer]);
                message.authorization = { authorSignature: jwsBuilder.getJws() };
        ...
        describe('attestation validation tests', () => {
            it('should fail with 400 if `attestation` payload contains properties other than `descriptorCid`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const authorSignaturePayload = Object.assign({}, recordsWrite.authorSignaturePayload);
                authorSignaturePayload.attestationCid = yield Cid.computeCid(attestationPayload);
                const authorSignaturePayloadBytes = Encoder.objectToBytes(authorSignaturePayload);
                const authorizationBuilder = yield GeneralJwsBuilder.create(authorSignaturePayloadBytes, [signer]);
