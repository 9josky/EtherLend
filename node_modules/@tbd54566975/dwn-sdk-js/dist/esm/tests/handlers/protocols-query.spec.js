    ...
    describe('ProtocolsQueryHandler.handle()', () => {
        ...
        describe('functional tests', () => {
            ...
            describe('Grant authorization', () => {
                ...
                it('rejects with 401 an external partys attempt to ProtocolsConfigure if the grant is not yet active', () => __awaiter(this, void 0, void 0, function* () {
                ...
                it('rejects with 401 an external partys attempt to ProtocolsConfigure if the grant has been revoked', () => __awaiter(this, void 0, void 0, function* () {
                ...
                it('rejects with 401 an external party attempts to ProtocolsConfigure if grant has different DWN interface scope', () => __awaiter(this, void 0, void 0, function* () {
                ...
                it('rejects with 401 an external party attempts to ProtocolsConfigure if grant has different DWN method scope', () => __awaiter(this, void 0, void 0, function* () {
