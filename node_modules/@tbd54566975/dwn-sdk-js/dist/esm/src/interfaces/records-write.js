...
export class RecordsWrite {
    ...
    static parse(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield validateMessageSignatureIntegrity(message.authorization.authorSignature, message.descriptor, 'RecordsWriteSignaturePayload');
            if (message.authorization.ownerSignature !== undefined) {
                yield validateMessageSignatureIntegrity(message.authorization.ownerSignature, message.descriptor);
            }
    ...
    sign(signer, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._message.recordId = (_a = this._message.recordId) !== null && _a !== void 0 ? _a : yield RecordsWrite.getEntryId(author, descriptor);
            ...
            if (this._message.contextId === undefined && this._message.descriptor.protocol !== undefined) {
                this._message.contextId = yield RecordsWrite.getEntryId(author, descriptor);
            }
            // `authorSignature` generation
            const authorSignature = yield RecordsWrite.createAuthorSignature(this._message.recordId, this._message.contextId, descriptorCid, this._message.attestation, this._message.encryption, signer, options);
