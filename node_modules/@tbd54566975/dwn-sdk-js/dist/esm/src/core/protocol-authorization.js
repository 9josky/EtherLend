...
export class ProtocolAuthorization {
    ...
    static verifyInvokedRole(tenant, incomingMessage, recordsWrite, protocolDefinition, messageStore) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const protocolRole = (_a = incomingMessage.authorSignaturePayload) === null || _a === void 0 ? void 0 : _a.protocolRole;
    ...
    static verifyAllowedActions(tenant, incomingMessage, recordsWrite, inboundMessageRuleSet, ancestorMessageChain, messageStore) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = incomingMessage.message.authorization) === null || _a === void 0 ? void 0 : _a.ownerSignature) !== undefined) {
            ...
            else if (incomingMessage.author !== undefined && ((_b = incomingMessage.authorSignaturePayload) === null || _b === void 0 ? void 0 : _b.permissionsGrantId) !== undefined) {
