...
export class PermissionsRevokeHandler {
    ...
    handle({ tenant, message }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingRevokesForGrant = yield this.messageStore.query(tenant, query);
            ...
            const grantAuthdMessagesAfterRevoke = yield this.messageStore.query(tenant, grantAuthdMessagesQuery);
