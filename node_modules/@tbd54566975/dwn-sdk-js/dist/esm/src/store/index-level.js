...
export class IndexLevel {
     ...
     */
    put(tenant, dataId, indexes, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const partition = yield executeUnlessAborted(this.db.partition(tenant), options === null || options === void 0 ? void 0 : options.signal);
            ...
            yield partition.batch(operations, options);
        });
    }
    /**
     * Executes the given single filter query and appends the results without duplicate into `matchedIDs`.
     */
    executeSingleFilterQuery(tenant, filter, matchedIDs, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
    ...
    query(tenant, filters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const matchedIDs = new Set();
            for (const filter of filters) {
                yield this.executeSingleFilterQuery(tenant, filter, matchedIDs, options);
            }
            return [...matchedIDs];
        });
    }
    delete(tenant, dataId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const partition = yield executeUnlessAborted(this.db.partition(tenant), options === null || options === void 0 ? void 0 : options.signal);
            const serializedIndexes = yield partition.get(`__${dataId}__indexes`, options);
            ...
            yield partition.batch(ops, options);
        });
    }
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    findExactMatches(tenant, propertyName, propertyValue, options) {
        var _a, e_1, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const partition = yield executeUnlessAborted(this.db.partition(tenant), options === null || options === void 0 ? void 0 : options.signal);
     ...
     */
    findRangeMatches(tenant, propertyName, rangeFilter, options) {
        var _a, e_2, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const partition = yield executeUnlessAborted(this.db.partition(tenant), options === null || options === void 0 ? void 0 : options.signal);
            const iteratorOptions = {};
            ...
            if ('lte' in rangeFilter) {
                ...
                for (const dataId of yield this.findExactMatches(tenant, propertyName, rangeFilter.lte, options)) {
                    matches.push(dataId);
                }
            }
            return matches;
