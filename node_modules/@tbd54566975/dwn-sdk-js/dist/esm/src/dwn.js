...
export class Dwn {
     ...
     */
    handleRecordsQuery(tenant, message) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const errorMessageReply = (_a = yield this.validateTenant(tenant)) !== null && _a !== void 0 ? _a : yield this.validateMessageIntegrity(message, DwnInterfaceName.Records, DwnMethodName.Query);
            if (errorMessageReply !== undefined) {
                return errorMessageReply;
            }
    ...
    handleRecordsRead(tenant, message) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const errorMessageReply = (_a = yield this.validateTenant(tenant)) !== null && _a !== void 0 ? _a : yield this.validateMessageIntegrity(message, DwnInterfaceName.Records, DwnMethodName.Read);
            if (errorMessageReply !== undefined) {
                return errorMessageReply;
            }
    ...
    handleMessagesGet(tenant, message) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const errorMessageReply = (_a = yield this.validateTenant(tenant)) !== null && _a !== void 0 ? _a : yield this.validateMessageIntegrity(message, DwnInterfaceName.Messages, DwnMethodName.Get);
            if (errorMessageReply !== undefined) {
                return errorMessageReply;
            }
    ...
    synchronizePrunedInitialRecordsWrite(tenant, message) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const errorMessageReply = (_a = yield this.validateTenant(tenant)) !== null && _a !== void 0 ? _a : yield this.validateMessageIntegrity(message, DwnInterfaceName.Records, DwnMethodName.Write);
            if (errorMessageReply !== undefined) {
                return errorMessageReply;
            }
            const options = {
